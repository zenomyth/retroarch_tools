...
# dpad
ol_portrait.add_single_button('nul', 210, dpad_height, 'rect', 200, 210, 'dpad.png', None)
...
# ab
ol_portrait.add_lr('nul', 'nul', ol_portrait.width - 190, abxy_height, 100, 80, 80, 'b.png', 'a.png', None, None)
...
# ss
ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 80, 60, 39, 'select.png', 'start.png', None, None)
