...
# ab
ol_portrait.add_ab('nul', 'nul', ol_portrait.width - 190, ab_height, 100, 40, 80, 80, 'b.png', 'a.png', None, None)
...
# ss
ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 110, 100, 31, 'select.png', 'start.png', None, None)

# lr
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, ol_portrait.width / 2 - 110, 100, 55, 'l.png', 'r.png', None, None)
