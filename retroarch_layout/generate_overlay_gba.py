...
ol_portrait.add_single_button('nul', dpad_center, dpad_height, 'rect', 200, 200, 'gba_dpad.png', None)
...
ol_portrait.add_ab('nul', 'nul', ab_center, ab_height, 100, 40, 80, 80, 'gba_b.png', 'gba_a.png', None, None)
ol_portrait.add_ab('b', 'a', ab_center, ab_height, 100, 40, 90, 90, None, None, None, None)
ol_portrait.add_single_button('a|b', ab_center, ab_height, 'rect', 15, 15, None, None)

ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 110, 100, 31, 'gba_select.png', 'gba_start.png', None, None)

ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, lr_d, 100, 55, 'gba_l.png', 'gba_r.png', None, None)
