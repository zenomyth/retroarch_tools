...
# thumbstick
ol_analog.add_single_button('nul', 210, dpad_height, 'radial', 200, 200, 'n64_thumbstick-background.png')
ol_analog.add_single_button('analog_left', 210, dpad_height, 'radial', 130, 130, 'n64_thumbstick-pad.png', None, '3.5', '0.75', 'true')

# ab
ol_analog.add_ab('nul', 'nul', ol_analog.width - 190, ab_height, 100, 40, 80, 80, 'n64_b.png', 'n64_a.png', None, None)
...
# zr
ol_analog.add_lr('l2', 'r', ol_analog.width / 2, lr_height, ol_analog.width / 2 - 110, 100, 50, 'n64_z.png', 'n64_r.png', None, None)
...
# dpad
ol_digital.add_single_button('nul', 210, dpad_height, 'rect', 200, 200, 'n64_dpad.png', None)
...
# ab
ol_digital.add_ab('nul', 'nul', ol_digital.width - 190, ab_height, 100, 40, 80, 80, 'n64_b.png', 'n64_a.png', None, None)
...
# lr
ol_digital.add_lr('l', 'r', ol_digital.width / 2, lr_height, ol_digital.width / 2 - 110, 100, 50, 'n64_l.png', 'n64_r.png', None, None)
