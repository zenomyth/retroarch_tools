...
ol_portrait.add_single_button('nul', dpad_center, dpad_height, 'rect', 200, 200, 'ds_dpad.png', None)
...
ol_portrait.add_cross_image('ds_x.png', 'ds_a.png', 'ds_b.png', 'ds_y.png', ab_center, abxy_height, 170, 175, 80)
...
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, lr_d, 60, 20, 'ds_l.png', 'ds_r.png', None, None)
