...
# dpad leftmost touch = center - 120(dx) - 90(r) = center - 210
dpad_center = margin + 210
# A rightmost touch = center + 100(d) + 90(rx) = center + 190
...
ol_portrait.add_single_button('nul', dpad_center, dpad_height, 'rect', 200, 200, 'nes_dpad.png', None)
...
ol_portrait.add_lr('nul', 'nul', ab_center, abxy_height, 100, 80, 80, 'nes_b.png', 'nes_a.png', None, None)
ol_portrait.add_lr('b', 'a', ab_center, abxy_height, 100, 90, 90, None, None, None, None)
ol_portrait.add_single_button('a|b', ab_center, abxy_height, 'rect', 10, 10, None, None)
