...
# dpad
ol_portrait.add_single_button('nul', 210, dpad_height, 'rect', 200, 200, 'ps_dpad.png', None)
...
# abxy
ol_portrait.add_cross_image('ps_x.png', 'ps_a.png', 'ps_b.png', 'ps_y.png', ol_portrait.width - 260, abxy_height, 170, 175, 80)
...
# lr
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, ol_portrait.width / 2 - 80, 70, 42, 'ps_l1.png', 'ps_r1.png', None, None)
