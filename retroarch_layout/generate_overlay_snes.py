...
# dpad
ol_portrait.add_single_button('nul', 210, dpad_height, 'rect', 200, 200, 'snes_dpad.png', None)
...
# abxy
ol_portrait.add_cross_image('snes_x.png', 'snes_a.png', 'snes_b.png', 'snes_y.png', ol_portrait.width - 260, abxy_height, 170, 175, 80)
...
# ss
ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 80, 60, 60, 'snes_select.png', 'snes_start.png', None, None)

# lr
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, ol_portrait.width / 2 - 110, 100, 50, 'snes_l.png', 'snes_r.png', None, None)
