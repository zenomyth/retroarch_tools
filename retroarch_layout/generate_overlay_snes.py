...
ol_portrait.add_single_button('nul', dpad_center, dpad_height, 'rect', 200, 200, 'snes_dpad.png', None)
...
ol_portrait.add_cross_image('snes_x.png', 'snes_a.png', 'snes_b.png', 'snes_y.png', ab_center, abxy_height, 170, 175, 80)
...
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, lr_d, 100, 50, 'snes_l.png', 'snes_r.png', None, None)
