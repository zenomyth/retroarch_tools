...
# lr
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, 1250, ol_portrait.width / 2 - 110, 100, 50, 'l1.png', 'r1.png', None, None)
...
# lr
ol_landscape.add_lr('l', 'r', ol_landscape.width / 2, 200, ol_landscape.width / 2 - 110, 100, 50, 'l1.png', 'r1.png', None, None)

# sl
ol_landscape.add_lr('load_state', 'save_state', ol_landscape.width / 2, 50, ol_landscape.width / 2 - 60, 50, 50, 'load.png', 'save.png', None, None)
