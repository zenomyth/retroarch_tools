...
ol_portrait.upper_margin = 209
ol_portrait.lower_margin = 129
dpad_height = 1550
...
# dpad
ol_portrait.add_single_button('nul', 210, dpad_height, 'rect', 200, 200, 'dpad.png', None)
...
# abxy
ol_portrait.add_cross_image('x.png', 'a.png', 'b.png', 'y.png', ol_portrait.width - 260, abxy_height, 170, 175, 80)
...
# ss
ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 80, 60, 60, 'select.png', 'start.png', None, None)

# lr
ol_portrait.add_lr('l', 'r', ol_portrait.width / 2, lr_height, ol_portrait.width / 2 - 110, 100, 50, 'l1.png', 'r1.png', None, None)
...
# ff
ol_portrait.add_single_button('toggle_fast_forward', 260, menu_height, 'rect', 50, 50, 'ff2.png', None)
