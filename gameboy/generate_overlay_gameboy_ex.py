...
# ab
ol_portrait.add_ab('nul', 'nul', ol_portrait.width - 190, abxy_height, 100, 40, 80, 80, 'b.png', 'a.png', None, None)
...
# ss
ol_portrait.add_lr('select', 'start', ol_portrait.width / 2, ss_height, 79, 59, 57, 'select.png', 'start.png', None, None)
...
# abss
ol_portrait.add_single_button('a|b|select|start', ol_portrait.width - 260, menu_height, 'rect', 50, 50, 'abss.png', None)
